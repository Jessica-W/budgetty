...
public class BudgetaryEventFactory : IBudgetaryEventFactory
{
    ...
    public BudgetaryEvent CreateIncomeEvent(DateOnly date, string userId, int amountInPennies,
        BudgetaryPool? debtPool = null)
    {
    ...
    public BudgetaryEvent CreateIncomeAllocationEvent(DateOnly date, string userId, int amountInPennies,
        BudgetaryPool pool)
    {
        return new BudgetaryEvent
        {
    ...
    public BudgetaryEvent CreatePoolTransferEvent(DateOnly date, string userId, int amountInPennies,
        BudgetaryPool sourcePool, BudgetaryPool destinationPool)
    {
        return new BudgetaryEvent
        {
            EventType = BudgetaryEvent.BudgetaryEventType.Expenditure,
